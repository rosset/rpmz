...
Source0:        https://github.com/tmux/%{name}/releases/download/%{version}/%{name}-%{temp_version}.tar.gz
...
%changelog
* Sat Jun 20 2026 Filipe Rosset <filiperosset@fedoraproject.org> - 3.7^rc-1
- copr for 3.7^rc
